...
alias mcmh="make clean && make html"
alias crmt="coverage run manage.py test -v 2 --debug-mode --settings 'ERP.settings_readthedocs'"
export PATH="/Users/youchen/miniconda3/bin:/usr/local/opt/opencv3/bin:$HOME/Library/Python/3.6/bin:/usr/local/sbin:$PATH"
